...
| 2026-04-04 | **10 nya fulltexter nedladdade:** candida-riskfaktorer (Thomas-Ruddel meta-analys), BDG (Cochrane + RCT + serial monitoring), PCT i candidemia, IgA-immunologi (gut homeostasis, dysbiosis, compensation). 7 bakom betalvägg noterade. Tillgångsfilen uppdaterad: 298 artiklar, 390 filer. |
| 2026-04-04 | **OMSTRUKTURERAD LANDNINGSSIDA (KUNSKAPSBASEN.md):** Specialitetsnavigering (2×2 rutnät: IVA/Neurolog/Infektion/Immunolog), hopfällbar tidslinje (sparar 4 skärmar), case-alert (gul ruta med bekräftad diagnos), statistik-chips, behandlingsalternativ-kort (helbredd), hopfällbar fullständig dokumentlista. +60 rader CSS. Inga ändringar i app.py/templates. 30-sekunderstest: läkare hittar sin specialitet inom 15 sek. |
| 2026-04-04 | RAG reindexerad: **1644 chunks** (22 docs + 298 fulltexts). |
...
| 2026-09-22 | Nytt symtom: pirrningar händer/fötter kopplat till ventilatorpasset → §4.3 tillagd (hypokapni-mekanism, Laffey 2002; psykologiskt ventilatorberoende, Jubran 2010). 29 ref. |
| 2026-09-22 | Parestesi-mönster bekräftat (under ventilering + lång MI-E, avtar vid egen andning) → hypokapni sannolik. MI-E-pausregel (4–6 cykler + paus) tillagd i §4.3 och fråga 23. |
| 2026-09-22 | Morgon-CO₂ svagt stigande över senaste dygnen → nattlig autonomi vid gränsen; morgonpasset motiverat men inställningar för hårda (hypokapni). MI-E 3×2–4 inom rekommendation. Snuttefilt-hypotes nedtonad i doc + Case. |
