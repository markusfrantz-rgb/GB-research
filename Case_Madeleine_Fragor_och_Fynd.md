...
## Patientprofil — Madeleine

*Baserat pa anhorighetsanamnes. Kan behova verifieras och kompletteras av behandlande lakare.*
...
| 2026-03-28 | MR hjarna genomford. |
...
- **Andning:** Egen andning hela dygnet sedan ~3–4 nätter. **Morgonblodgasen visar en svag stigande CO₂-trend över de senaste dygnen** (värden ej kända) — förenligt med begynnande ackumulerad nattlig hypoventilation; talar för att morgonpasset har ett syfte men bör ställas in mot normokapni (pirrningarna = överkorrigering). Sover med fuktnäsa (HME) på kanylen. Respirator **endast ~1 h/morgon**; blodgas tagen *före* passet rapporteras fin. SpO₂ 96–99 % dygnet runt utan syrgas. Dessförinnan respirator endast nattetid i ~6 veckor.
...
- **Nytt symtom (22/9):** **Pirrningar i händer/armar och fötter/ben**, rapporterade i samband med ventilatorproblem. **Tidssamband bekräftat 22/9: kommer snabbt under ventilering och vid hostmaskin när slemmet inte lossnar; avtar när hon andas själv.** Mönstret är förenligt med hypokapni vid överventilation (ej sensorisk regeneration, som är oberoende av maskin). Bekräftas med blodgas *efter* passet. IVA-läkare har framfört att ventilatorn ofta behålls längre än nödvändigt av både patient och personal ("snuttefilt").
...
**1. Elektrofysiologi (NCS/EMG)**
Har nervledningshastighet/EMG utforts? Undersokningen avgor GBS-subtyp (AIDP/AMAN/AMSAN) och ar avgörande for prognos. Vid inexcitabla nerver i >=4 motoriska nerver sjunker sannolikheten for aterhamtning till gangformaga fran 81% till 23% (Shahrizaila et al., 2024).

**2. Gangliosid-antikroppar**
Har anti-gangliosidpanel skickats (GM1, GD1a, GQ1b m.fl.)? Antikroppsmonster identifierar subtyp och kan styra behandlingsval. Persistens av hoga anti-GM1 IgG-titrar (>1600) ar forknippat med samre aterhamtning (HR 2.11).

**3. Anti-IgA-antikroppar (IgE- och IgG-klass)**
Kritiskt infor eventuell IVIg-behandling. IgE-anti-IgA innebar reell anafylaxirisk, medan IgG-anti-IgA (vanligare) sallan ger svara reaktioner (Rachid & Bonilla, JACI 2012). Snabbtest (ID-PaGIA) finns — resultat inom timmar.

**4. Neurofascin-antikroppar (NF155, NF186)**
Kan skilja GBS fran akut-debuterande CIDP, vilket helt andrar behandlingsstrategin (underhallsimmunterapi).

**5. Serum-NfL (neurofilament light chain)**
Basta biomarkoren for axonal skada. Median 85.5 pg/mL vid GBS (vs 9.1 kontroller). Patienter under median: 93% utskrivna med gangformaga vs 54% over. Toppvarde vid ~22.8 dagar — vardet vid vecka 2 ar starkare prediktor an baseline (IGOS-kohort n=281).
...
Med 36 ars intervall sedan forsta episoden: 8-veckorsregeln (progression >8 veckor = misstank CIDP) och "rule of three" (>=3 fluktuationer = CIDP) bor utvarderats. CSF IL-8 vid cut-off 70 pg/mL har 96.7% specificitet for att skilja GBS fran CIDP.
...
- LMWH (enoxaparin 40 mg SC dagligen)?
- IPC-enheter (intermittent pneumatisk kompression)?
- LMWH bor hallas pa PE-dagar och ateruptas nar fibrinogen >1.0 g/L.
...
**16. TSH/fT4/fT3 — BESVARAT 2026-03-26/27**
**Svar (2026-03-26):** TSH mycket lagt, fT4 10-12 pmol/L (lag-normal).
**Svar (2026-03-27):** fT3: **normalt**.
**Tolkning:** Sannolikt **sick euthyroid syndrome** (non-thyroidal illness) — cytokiner fran svar sjukdom trycker ner TSH, perifer T4→T3-konvertering minskar. fT4 10-12 ar lag-normal, alltsa INTE overreplacement — levotyroxindosen bor INTE sankas. fT3 normalt ar ett positivt fynd — innebar att T3-beroende nervregeneration (Schwann-cellsmyelinisering, BDNF, NGF) inte hammas av tyreoideadysfunktion.
**Klinisk relevans:** Normalt fT3 innebar att T3-substitution ej ar aktuellt. Fortsatt monitorering rekommenderas vid prolongerad IVA-vard.
...
Om blodgasen *före* passet är normal finns inget att "vädra ut" — passet fungerar då som säkerhetsmarginal/vila. Litteraturen saknar studier på *när* nattlig ventilation ska avslutas; praxis är att invertera startkriterierna (ERS 2013, CHEST 2023): normal morgongas ×3, ingen nattlig desaturation (<88 % ≥5 min), ingen nattlig hyperkapni. **Pirrningar i händer/fötter:** Uppträder snabbt under ventilering och avtar vid egen andning → *över*ventilation → hypokapni → respiratorisk alkalos → sänkt joniserat kalcium → parestesier (Laffey & Kavanagh, NEJM 2002). En blodgas *efter* passet (lågt pCO₂, högt pH) bekräftar. **Samtidigt stiger morgon-CO₂ svagt** → natten är vid sin gräns. Båda är förenliga: passet behövs, men inställningarna skjuter förbi målet. Rimlig åtgärd: sänk minutventilationen mot normalt CO₂ vid passets slut, styrt av blodgas efter passet — inte ta bort passet. Psykologiskt ventilatorberoende (Jubran 2010: 42 % depressiva symtom, weaningmisslyckande 61 % vs 33 %) är en hypotes att pröva, inte en slutsats — CO₂-trenden talar för ett verkligt behov just nu.
**Fråga:** Finns ett definierat kriterium, och kan en nattlig transkutan CO₂-registrering (PtcCO₂) göras för att bekräfta att natten klaras utan REM-relaterad hypoventilation? En enstaka morgongas fångar inte episoder mitt i natten (Ogna 2016; Orlikowski 2017). Kan en blodgas tas *efter* passet för att bekräfta hypokapni och styra inställningarna? **Nattlig mätning:** en nattlig *blodgas* är inte meningsfull (ett stick, en tidpunkt, väcker patienten, missar REM) — det som avses är **transkutan CO₂ (PtcCO₂)**, en icke-invasiv sensor som registrerar hela natten, normalt tillgänglig via lungklinik/hemventilationsteam. Reservmetod: nattlig pulsoximetri + morgongas (ERS). **Hostmaskinen:** 3 in/ut × 2–4 omgångar är inom rekommendationen (4–6 + paus, Chatwin 2018); pirrningarna vid svår hostning beror då snarare på stressdriven snabbandning — paus med egen andning mellan omgångarna.
...
|---------|--------|-----------|
| PE → IVIg | Vanta >=48h efter sista PE | PE vaskar inte ut IVIg givet *efterat*. SID-GBS (andra IVIg-kur) galler ej vid byte fran PE. |
| PE → Efgartigimod | 24-48h efter sista PE | Inget farmakologiskt hinder. **Sakraste sekvensen vid IgA-brist** — ingen Ig-exponering. |
| PE → Imlifidase | Ingen vantetid kravs | Fordel: klyver *enbart* IgG, paverkar ej koagulationsfaktorer — fordel vid koagulopati. |
| IVIg → Efgartigimod | Vanta 7-14 dagar | Efgartigimod accelererar nedbrytning av ALL IgG, inklusive terapeutiskt IVIg. |

### Koagulation

| Parameter | Trotskel | Atgard |
|-----------|----------|--------|
| Fibrinogen <1.0 g/L | Pausa PE | Kryoprecipitat 10 enheter eller fibrinogenkoncentrat 2-4 g |
| Fibrinogen >1.5 g/L, TPK >50, INR <1.5 | Saker trakeostomi | Planera 48-72h efter sista PE |
| DVT-profylax | Alltid | LMWH + IPC. Hall LMWH pa PE-dagar, aterupta nar fibrinogen >1.0 |

### Skoldkorteln och GBS
...
All evidens bakom detta dokument finns tillganglig i en sokbar kunskapsdatabas:
