...
- **Nytt symtom (22/9):** **Pirrningar i händer/armar och fötter/ben**, rapporterade i samband med ventilatorproblem. Tidssamband med morgonpasset ej klarlagt. Differentialdiagnos: hypokapni vid överventilation (kommer under/efter passet, klingar av inom ~30 min) vs sensorisk regeneration (oberoende av ventilatorn). IVA-läkare har framfört att ventilatorn ofta behålls längre än nödvändigt av både patient och personal ("snuttefilt").
...
Om blodgasen *före* passet är normal finns inget att "vädra ut" — passet fungerar då som säkerhetsmarginal/vila. Litteraturen saknar studier på *när* nattlig ventilation ska avslutas; praxis är att invertera startkriterierna (ERS 2013, CHEST 2023): normal morgongas ×3, ingen nattlig desaturation (<88 % ≥5 min), ingen nattlig hyperkapni. **Pirrningar i händer/fötter:** Om de uppträder under eller strax efter passet talar det för *över*ventilation → hypokapni → respiratorisk alkalos → sänkt joniserat kalcium → parestesier (Laffey & Kavanagh, NEJM 2002). En blodgas *under/efter* passet (lågt pCO₂, högt pH) bekräftar. Sensorisk regeneration ger också parestesier, men oberoende av ventilatorn. **Snuttefilt-dynamiken** (patientens rädsla + personalens försiktighet) är väl beskriven — Jubran 2010: depressiva symtom hos 42 % under prolongerad weaning, weaningmisslyckande 61 % vs 33 % — men kan bara skiljas från verkligt behov genom mätning.
**Fråga:** Finns ett definierat kriterium, och kan en nattlig transkutan CO₂-registrering (PtcCO₂) göras för att bekräfta att natten klaras utan REM-relaterad hypoventilation? En enstaka morgongas fångar inte episoder mitt i natten (Ogna 2016; Orlikowski 2017). Kan en blodgas tas *efter* passet för att utesluta hypokapni som orsak till pirrningarna?
